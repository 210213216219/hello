...
while (
  ...
  "1343319","1112035","1350259","367971",  // Fighting Sun,Northern Meteor,Irish Darling,Ivorys Irish
  ...
  "369621","337102","445024","335975",     // Tale of the Cat,Storm Cat,Yarn,Mr. Prospector
  ...
  "1360502","1171845","1328547","897467",  // -,シルバーステート,Forever Yours,Motivator
  ...
  "112440","619817","750290","333862",     // ロゴタイプ,ローエングリン,ステレイタイプ,Sunday Silence
  ...
  "3","1113348","450238","3365722",        // Burn The Floor,Indian Haven,Dance Time,Sadler's Wells
  ...
  "1360740","1165020","1249475","1003260", // サイブレーカー,Uncle Mo,Downside Scenario,Scat Daddy
  ...
  "1185025","762497","615084","161740",    // カザキリ,オンファイア,フラッシュカード,Tony Bin
...
let ctx = new Array(502), order = [], e, f;
while (
  ctx[--i] = [
...
header[4].onclick =()=> {
  let i = 502, fragment = new DocumentFragment;
